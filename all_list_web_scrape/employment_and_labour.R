...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/employment-and-labour?order=name&file-content=no")
...
employment_and_labour <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "employment_and_labour",
...
write.csv(employment_and_labour, 
          file = "data/table_list/employment_and_labour_table.csv")
