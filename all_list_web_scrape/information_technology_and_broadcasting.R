...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/information-technology-and-broadcasting?order=name&file-content=no")
...
information_technology_and_broadcasting <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "information_technology_and_broadcasting",
...
write.csv(information_technology_and_broadcasting, 
          file = "data/table_list/information_technology_and_broadcasting_table.csv")    
