...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/commerce-and-industry?order=name&file-content=no")
...
commerce_and_industry <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "commerce_and_industry",
...
write.csv(commerce_and_industry, 
          file = "data/table_list/commerce_and_industry_table.csv")  
