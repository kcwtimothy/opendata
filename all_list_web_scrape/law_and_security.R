...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/law-and-security?order=name&file-content=no")
...
law_and_security <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "law_and_security",
...
write.csv(law_and_security, 
          file = "data/table_list/law_and_security_table.csv")   
