...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/recreation-and-culture?order=name&file-content=no")
...
recreation_and_culture <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "recreation_and_culture",
...
write.csv(recreation_and_culture, 
          file = "data/table_list/recreation_and_culture_table.csv")    
