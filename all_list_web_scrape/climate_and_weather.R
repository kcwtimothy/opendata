...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/climate-and-weather?order=name&file-content=no")
...
climate_and_weather <- ref[rep(
  ...
  mutate(data_dataset = as.character(stat),
         ...
         data_category = "climate_and_weather",
...
write.csv(climate_and_weather, 
          file = "data/table_list/climate_and_weather_table.csv")  
