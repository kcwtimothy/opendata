...
#get info on health data========================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/health?order=name&file-content=no")
...
#get all 91 links for the data_tables===========================================
link <-  html(page_source[[1]]) %>% 
...
write.csv(health, 
          file = "data/table_list/health_table.csv")  
