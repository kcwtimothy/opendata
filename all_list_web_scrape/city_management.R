...
#get info on  data==============================================================
remDr$navigate("https://data.gov.hk/en-datasets/category/city-management?order=name&file-content=no")

#dynamic webpage,needs to scroll down x times to reveal all the results=========
replicate(2,
          {
...
write.csv(city_management, 
          file = "data/table_list/city_management_table.csv")  
